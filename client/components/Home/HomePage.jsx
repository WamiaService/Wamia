    ...
    if (searchTerm.trim() !== '') {
      ...
      axios
        .get(
          ...
          `http://192.168.1.7:3000/provider/search?category=${searchTerm}`
        )
        .then((response) => {
      ...
      if (providerId) {
        try {
          const response = await axios.get(
            ...
            `http://192.168.100.2:3000/provider/getOne/${providerId}`
          )
      ...
      if (custumorId) {
        try {
          const response = await axios.get(
            ...
            `http://192.168.100.2:3000/custumor/getOne/${custumorId}`
          );
