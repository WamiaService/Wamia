...
const ServicesOneProvider = ({providerId}) => {
  ...
  const del = (id) => {
    axios
      ...
      .delete(`http://192.168.100.10:3000/service/delete/${id}`)
      .then((res) => {
        console.log(res);
  ...
  const fetch = () => {
    axios.get(`http://192.168.104.7:3000/service/getall/${providerId}`)
    axios.get(`http://192.168.100.10:3000/service/getall/${providerId}`)
      .then((res) => {
        setData(res?.data);
      })
      .catch((err) => {
