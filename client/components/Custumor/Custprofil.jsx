...
// Custumor Info 
   const custInfo=()=>{
    ...
    console.log("token",token)
       ...
       axios
        .post("http://192.168.104.6:3000/custumor/login"),{
  ...
  const getOneCustumor = async (id)=> {
    ...
    try {
      const response = await axios.get(`http://192.168.104.6:3000/custumor/getOne/${id}`);
  ...
  const updateCus=(id,username,adresse,mobile)=>{
    ...
    axios.put(`http://192.168.104.6:3000/custumor/update/${id}`,{
      username: username,
      adressse:adresse,
      // imgprof:imgprof,
      mobile:mobile
